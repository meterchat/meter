  ...
  return (
    <div className="relative flex h-screen flex-col items-center bg-background px-4 overflow-hidden">
        ...
        {step === "no-account" && (
          <div className="flex flex-col items-center gap-3 w-full">
            ...
            <p className="text-xs text-muted-foreground/70 leading-relaxed">
              This is a private tool. Sign in from a device where you&apos;re already set up.
            </p>
            ...
            >
              ...
              {loading ? "Authenticating..." : "Sign in from another device"}
            </button>
      ...
      <div className="fixed bottom-6 right-6 z-20 flex items-center gap-3">
        <a href="https://github.com/meterchat/mcp" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/40 hover:text-muted-foreground transition-colors">
        ...
        <a href="https://x.com/meter_chat" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/40 hover:text-muted-foreground transition-colors">
