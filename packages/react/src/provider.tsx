...
const DEFAULT_MODELS: MeterModel[] = [
  { id: "auto", name: "Auto", provider: "Meter", inputPrice: 1.75 / 1_000_000, outputPrice: 14.0 / 1_000_000 },
  ...
  { id: "openai/gpt-5.4", name: "GPT-5.4", provider: "OpenAI", inputPrice: 2.0 / 1_000_000, outputPrice: 16.0 / 1_000_000 },
  { id: "openai/gpt-5.4-pro", name: "GPT-5.4 Pro", provider: "OpenAI", inputPrice: 5.0 / 1_000_000, outputPrice: 30.0 / 1_000_000 },
